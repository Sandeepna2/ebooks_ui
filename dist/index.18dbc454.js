...
function createBookCard(book) {
    const bookFooterElement = createElement("div", [
        "card-footer",
        "d-flex",
        "justify-content-between"
    ]);
    const viewDetailsButton = createElement("a", [
        "btn",
        "btn-primary"
    ], {
        href: "#"
    }, "View Details");
    const buyNowButton = createElement("a", [
        "btn",
        "btn-success"
    ], {
        href: "#"
    ...
    const bookBodyElement = createElement("div", [
        "card-body"
    ]);
    const bookTitleElement = createElement("h5", [
        "card-title"
    ], {}, book.title);
    const bookAuthorElement = createElement("h6", [
        "card-subtitle",
        "mb-2",
        "text-muted"
    ], {}, `by ${book.author}`);
    const bookPriceElement = createElement("p", [
        "card-text",
        "fw-bold"
    ], {}, `\u{20B9}${book.price}`);
    ...
    const bookColElement = createElement("div", [
        "col"
    ]);
    const bookCardElement = createElement("div", [
        "card",
        "h-100"
    ]);
    const bookImageElement = createElement("img", [
        "card-img-top"
    ], {
        src: book.image,
        alt: book.title
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["8rYT3","1SICI"], "1SICI", "parcelRequire4f36")
